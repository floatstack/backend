    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    logger_js_1.logger.info('Successfully connected to the database');
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    (0, helper_js_1.handlePrismaError)(error_1);
                    logger_js_1.logger.error('Failed to connect to the database', { error: error_1 });
                    process.exit(1);
                    return [3 /*break*/, 3];
...
connectDB().catch(function (error) {
    logger_js_1.logger.error('Initial database connection failed', { error: error });
    process.exit(1);
});
